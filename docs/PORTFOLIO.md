...
- High: strong narrative + clear evaluation strategy + artifact path.
- Medium: useful project, partially missing reproducibility details.
- Reference: useful but not yet standardized for interview/presentation quality.
- Low: showcased for context only.

## Next work queue

1. Add remaining featured repo pages using the same case-study format.
